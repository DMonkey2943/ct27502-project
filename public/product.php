            ...
            <div class="col-2">
                ...
                <ul class="category">
                    <li class="category_item">
                        <a href="" class="category_link">Tất cả sản phẩm</a>
                    </li>
                    <li class="category_item">
                        <a href="" class="category_link">Trái cây Việt Nam</a>
                    </li>
                    <li class="category_item">
                        <a href="" class="category_link">Trái cây nhập khẩu</a>
                    </li>
                    <li class="category_item">
                        <a href="" class="category_link">Quà tặng trái cây</a>
                    </li>
                </ul>
            </div>
            <div class="col-10">

...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <form action="addProduct.php" method="post" class="col-md-6 offset-md-3">
                    ...
                    <div class="d-grid">
                        <button type="submit" name="submit" class="btn btn-primary btn-block log-btn">Thêm sản phẩm</button>
                    </div>
